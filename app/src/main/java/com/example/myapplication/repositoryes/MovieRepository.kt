...
class MovieRepository {
    private var movieList = mutableListOf<CatDataClass>()
    fun getMovieList() : MutableList<CatDataClass>{
        ...
        movieList.add(
            CatDataClass(
                "https://metarankings.ru/images/uploads/Mad-Max-Fury-Road-cover-100x140.jpg",
